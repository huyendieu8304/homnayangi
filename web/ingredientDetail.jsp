                                ...
                                <c:forEach items="${bestSellerList}" var="b">
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded" style="width: 100px; height: 100px;">
                                            <img src="${b.imageUrl}" class="img-fluid rounded" alt="Image">
                                        </div>
                                        <div style="margin-left: 20px">
                                            <a href="ingredientDetail?id=${b.getIngredientId()}" class="h5">
                                                <h6 class="mb-2">${b.ingredientName}</h6>
                                            </a>
                                            ...
                                            <div class="d-flex mb-2">
                                                <h5 class="fw-bold me-2">${b.getFormattedPrice()} đ</h5>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>   
